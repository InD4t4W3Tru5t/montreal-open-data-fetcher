...
TRANSLATIONS = {
    "en": {
        ...
        "fetch_resource_btn": "Fetch this resource",
        ...
        "idle_browser": "👆 Select a dataset from the list above to see its details.",
        "idle_resource": "👆 Select a resource from the list above to fetch it.",
    ...
    "fr": {
        ...
        "fetch_resource_btn": "Récupérer cette ressource",
        ...
        "idle_browser": "👆 Sélectionnez un jeu de données dans la liste ci-dessus pour voir ses détails.",
        "idle_resource": "👆 Sélectionnez une ressource dans la liste ci-dessus pour la récupérer.",
        ...
        if resources:
            ...
            if res_fmt and not is_tabular(res_fmt):
                ...
                if total_count and total_count > 0:
                    ...
                    browser_max_rows = None
                if st.button(t("fetch_resource_btn"), type="primary", use_container_width=True):
